...
from cli import advisor_cmd, clerk_cmd, etoro_cmd
...
@app.command()
def ui():
    """Open the local Streamlit UI (browser). Works when `tradingagents-ui` is not on your PATH."""
    from cli import ui_launch

    raise SystemExit(ui_launch.main())
